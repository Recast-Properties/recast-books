...
const DECIDE_SCHEMA = {
  ...
  properties: {
    ...
    checked: { type: "string", description: "Your working: what you zoomed, reconciled, looked up, and what stayed unresolved. Shown only when a reviewer opens the item." },
