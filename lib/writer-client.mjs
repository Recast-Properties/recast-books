...
export const LOST_REPLY = new Set(["REDIRECT_MISFIRE", "BAD_RESPONSE", "NETWORK_ERROR"]);
...
export function createWriter({ url, secret, fetchImpl = fetch, retryDelayMs = 1500 }) {
  ...
  return {
    ...
    // D-035: fills doc_url on the Journal lines of txn_ids (the Inbox sidebar's setDocUrl_ path).
    setDocUrl: (txn_ids, url) => call("setDocUrl", { txn_ids, url }),
