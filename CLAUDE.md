...
- **Open (§27):** differences list (117), in mail not in the books (168, utilities first), confirm list (57 small), Drive filing, listing search folded into `migration-compare.py`, skip-rebuild flag for the advances registration, Dennis's PayPal listing-fee receipts, settlement dates for Ashburne and Newport, production writer push, cutover. Pipeline steps: §21.
