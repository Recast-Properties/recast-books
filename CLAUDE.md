...
are the target, D-028 returns hold for Paul). **Resume from `HANDOFF-2026-09-25.md` (then `HANDOFF-2026-09-23.md`, `docs/phase4-audit.md` §51-§66)** - state on 2026-09-23:
...
- **2026-09-25 evening - THE PLAN BUILT, NOT DEPLOYED (D-047):** reads come off the writer (`lib/sheets-reader.mjs`, on when `SHEETS_SA_KEY` is set), approve posts in `/api/approve-bg`, the nightly books check `/api/reconcile-bg` (code gathers, the model judges, digest prints it first). Paul's nine-step sequence is at the end of `HANDOFF-2026-09-25.md`. 479 tests.
