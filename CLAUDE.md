...
are the target, D-028 returns hold for Paul). **Resume from `docs/phase4-audit.md` §27** (independent audit 2026-09-18, `docs/phase4-independent-audit.md`: amounts sound; Granite $299 row, advances registration, matcher fixed - D-032 Ashburne's "Dennis paid" lines are cash advances landing on 2030, D-033 the sale side is Phase 5; rebuilt dry run 1,035 entries $220,779.39, **staging pass 4 ran 2026-09-18 13:14 and ties out to the cent at $220,774.59, §23; prompt + image-type fixes deployed the same day**; §21 for the pipeline) (paused 2026-09-18: staging pass 2 tied out to the cent; cleanup items 1-2 closed, 3-4 partly, 5-7 open; D-030 interest by deal type, D-031 Cost Recapture; Paul's answers in `data/migration/2026-09-17/paul-answers.json`).** The production writer still needs the 2026-09-18 formula fix pushed (§15).
