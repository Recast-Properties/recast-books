...
are the target, D-028 returns hold for Paul). **Resume from `docs/phase4-audit.md` §21** (paused 2026-09-18: staging pass 2 tied out to the cent; cleanup items 1-2 closed, 3-4 partly, 5-7 open; D-030 interest by deal type, D-031 Cost Recapture; Paul's answers in `data/migration/2026-09-17/paul-answers.json`).** The production writer still needs the 2026-09-18 formula fix pushed (§15).
