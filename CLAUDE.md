...
- **2026-09-25 (D-044..D-046, `HANDOFF-2026-09-25.md`):** D-046 a utility payment matching nothing on the account posts; `checked` was being dropped by `normalizeDecide` since 09-22 - kept now; a lost postBatch reply is confirmed on the Journal; ledger window 365 days (NOT deployed as of the handoff); two replay duplicates voided; Atmos 67.39 Pending for Paul.
