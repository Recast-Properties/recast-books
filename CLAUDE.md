...
- **Staging pass 5 (15:41) tied out** on both paths: 1,031 entries, $220,628.06, $0.00 on all nine, 868 linked, 33 advances (§28). Utilities pass (§29): 22 of 25 documents settled under `mail_settled` in `paul-answers.json`; **four payments on no old tab wait for Paul** (Bowling Green TXU $164.02 + Red Oak $529.24, Ashburne Energy Texas $484.43, Mesa Central States $49.54) plus the Bowling Green $102.12 / $102.16 typo. Skip-rebuild flag for the advances registration built and pushed to staging, not yet run.
- **Open (§27):** differences list (117), in mail not in the books (146 left after the utilities), confirm list (57 small), Drive filing, listing search folded into `migration-compare.py`, Dennis's PayPal listing-fee receipts, settlement dates for Ashburne and Newport, production writer push, cutover. Pipeline steps: §21.
