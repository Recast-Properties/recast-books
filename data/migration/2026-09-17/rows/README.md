...
Old rows: 1029  $221,725.59   entries: 1055  $242,768.46   linked to a receipt: 921 (398 Drive file, 523 Gmail link, to be filed)

| property | old rows $ | entries | entries $ | difference | linked |
|---|---:|---:|---:|---:|---:|
| 104 Ashburne | 165,007.93 | 471 | 178,671.40 | 13,663.47 | 392 |
...
Accounts: {'block map': 80, 'read': 764, 'D-026.9 fuel block': 58, 'payee': 127, 'Paul/Claude': 26}
Paid from: {'PAUL': 949, '1401': 69, 'DENNIS': 35, '1402': 2}  (sources: {'read': 641, 'D-026.2': 115, "Paul: 2026-09-18: the other 33 August-onward rows with no payer - 'all personal card ending in 9166'": 34, "Paul: 2026-09-18: camera gimbal - 'that one is recast joint account - citizens'": 1, 'Paul Paid box': 140, 'Recast Account box': 62, 'Dennis Paid box': 33, 'D-032': 3, 'receipt': 26})
