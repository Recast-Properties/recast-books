...
Old rows: 1029  $221,712.19   entries: 1054  $242,611.06   linked to a receipt: 898 (382 Drive file, 516 Gmail link, to be filed)

| property | old rows $ | entries | entries $ | difference | linked |
|---|---:|---:|---:|---:|---:|
| 104 Ashburne | 165,007.93 | 471 | 178,671.40 | 13,663.47 | 383 |
...
| OVERHEAD | 21,908.91 | 337 | 27,504.24 | 5,595.33 | 320 |
...
Accounts: {'block map': 82, 'read': 743, 'D-026.9 fuel block': 58, 'payee': 146, 'Paul/Claude': 25}
Paid from: {'PAUL': 949, '1401': 68, 'DENNIS': 35, '1402': 2}  (sources: {'read': 635, 'D-026.2': 121, "Paul: 2026-09-18: the other 33 August-onward rows with no payer - 'all personal card ending in 9166'": 34, "Paul: 2026-09-18: camera gimbal - 'that one is recast joint account - citizens'": 1, 'Paul Paid box': 140, 'Recast Account box': 62, 'Dennis Paid box': 33, 'D-032': 3, 'receipt': 25})

Lists for Paul: 1 differences 118 · 2 confirm the match 54 · 3 no document 101 · 4 in mail, not in the books 61 · 5 questions 37
