...
## B · documents matched by vendor/date/amount: 788  {'twin': 53, 'junk (dismissed)': 148, 'property row now documented': 345, 'in mail, not in old books': 199, 'manual row now documented': 43}
## C · old rows nothing covers: 245  (with a weak candidate document: 228)  by (tab, had a message id): {('RECAST BIZ', False): 23, ('881 Newport', False): 8, ('469 Brushwood', False): 5, ('366 Mesa', False): 17, ('136 Bowling Green', False): 9, ('104 Ashburne', False): 147, ('1616 Granite RECONCILED', False): 28, ('280 Sparkling RECONCILED', False): 7, ('Cost Recapture', False): 1}
