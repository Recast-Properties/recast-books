...
## B · documents matched by vendor/date/amount: 788  {'twin': 53, 'junk (dismissed)': 240, 'property row now documented': 301, 'in mail, not in old books': 160, 'manual row now documented': 34}
## C · old rows nothing covers: 302  (with a weak candidate document: 284)  by (tab, had a message id): {('RECAST BIZ', False): 35, ('881 Newport', False): 7, ('469 Brushwood', False): 10, ('366 Mesa', False): 18, ('136 Bowling Green', False): 14, ('104 Ashburne', False): 185, ('1616 Granite RECONCILED', False): 25, ('280 Sparkling RECONCILED', False): 8}
