...
## B · documents matched by vendor/date/amount: 788  {'twin': 53, 'junk (dismissed)': 176, 'property row now documented': 344, 'in mail, not in old books': 170, 'manual row now documented': 45}
## C · old rows nothing covers: 226  (with a weak candidate document: 208)  by (tab, had a message id): {('RECAST BIZ', False): 19, ('881 Newport', False): 8, ('469 Brushwood', False): 5, ('366 Mesa', False): 17, ('136 Bowling Green', False): 9, ('104 Ashburne', False): 132, ('1616 Granite RECONCILED', False): 28, ('280 Sparkling RECONCILED', False): 7, ('Cost Recapture', False): 1}
## D · vendor-days where net differs: 488  (sum of diffs $43,912.41)
## F · receipts above the old rows they explain (D-028 returns): 89  {'hold': 70, 'return inferred': 19}  inferred $432.19
